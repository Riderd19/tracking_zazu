...
export default function App() {
  ...
  useEffect(() => {
    if (!ultimaBusqueda || pedido?.estado_actual?.codigo !== CODIGO_EN_RUTA)
      return;
  ...
  if (pedido) {
    return (
      <div className="min-h-screen w-full bg-white flex flex-col">
        ...
        <div className="w-full max-w-[2000px] min-h-screen mx-auto flex-1 flex flex-col gap-6 px-4 pt-6 pb-10 sm:px-8">
          <OrderResult
            pedido={pedido}
            identidad={ultimaBusqueda}
      ...
      <div className="w-full flex-1 flex items-center justify-center px-4 py-14">
        <div className="w-full max-w-md flex flex-col items-center">
          ...
          <p className="text-sm text-gray-500 text-center max-w-sm mb-8">
            Ingresa tu número de pedido y tu DNI o celular para consultar el
            estado y la ubicación de tu pedido en tiempo real.
          </p>
